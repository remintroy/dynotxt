...
const ioNotificationsHandler = (io: Server, socket: Socket) => {
  ...
  socket.on("notification:welcome", (data) => {
    //  [
    //   {
    //     type: "new_blog",
    //     readed: false,
    ...
    //       title: "Nodejs is a great way to develop backend",
    //       createdAt: new Date(),
    //       authorName: "Remin T Roy",
    //       blogId: "SDJF98897DF787DFFD",
    //     },
    //   },
    //   {
    //     type: "new_login",
    ...
    //       name: "Remin",
    //       photoURL:
    //         "https://firebasestorage.googleapis.com/v0/b/dynotxt.appspot.com/o/users%2FVDZcgLG8apOnghcrGK9Gz2RFgJF2%2Fpp.png?alt=media&token=aed617e1-8f66-4b45-a218-ac00293254fb",
    //       createdAt: new Date(),
    //     },
    //   },
    // ];
