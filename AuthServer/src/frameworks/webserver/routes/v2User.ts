...
// import { emailService, utilService } from "../../../application/services/commonServices";
...
//   router.route("/verify/:uid/email").post(makeExpressResponseCallback(controller.postVerifyEmailWithOtp));

//   router.route("/user/logout").get(mustLoginAsUser, makeExpressResponseCallback(controller.getUserLogout));

//   router.route("/user/signin").post(makeExpressResponseCallback(controller.userPostSignin));

//   router.route("/user/refresh").get(makeExpressResponseCallback(controller.getNewAccessTokenFromRefreshToken));

//   router.route("/user/initial").get(makeExpressResponseCallback(controller.getInitialUserDataFromRefreshToken));

//   router.route("/user/data/:uid").get(makeExpressResponseCallback(controller.getUserDataPublic));

//   router
//     // user data for dashboard - settings
//     .route("/user/data/profile")
//     .get(mustLoginAsUser, makeExpressResponseCallback(controller.getDataForCurrentUserDashboard))
//     .put(mustLoginAsUser, makeExpressResponseCallback(controller.putCurrentUserData));
