import { Alert, Button, Flex, Input, Loader, Text } from "@mantine/core";
    ...
    return (
      <>
        ...
        <Input
          ...
          mt={10}
          placeholder="Your issue with the blog"
        />
              ...
              if (reason.split("").length > 1) {
                try {
                  ...
                  notifications.show({
                    ...
                    message:
                      "Thank you for you feedback. Your report has been submitted and required action will be taken soon.",
                  });
                } catch (error: any) {
                  notifications.show({
                    color: "red",
