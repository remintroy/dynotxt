...
import { IconBookmark, IconThumbDownFilled, IconThumbUpFilled } from "@tabler/icons-react";
...
const BlogActionButtonComponent = ({ blogId }: { blogId?: string }) => {
...
export default BlogActionButtonComponent;
