...
import { ActionIcon, Avatar, Box, Button, Card, Flex, Grid, Input, Loader, Menu, Paper, Text } from "@mantine/core";
import { IconChevronDown, IconChevronRight, IconChevronUp, IconDotsVertical, IconSend } from "@tabler/icons-react";
...
const CommentComponent = ({ data, skip, blogId }: { data: any; skip?: boolean; blogId: string | undefined }) => {
  ...
  const deleteCommentConfirmation = (id: string) =>
    modals.openConfirmModal({
      ...
      children: (
        <Text size="sm">This will remove your comment from this blog permenantly and you cannot recover it.</Text>
      ),
            ...
            {user?.uid == data?.uid && (
              <Menu trigger="hover" shadow="md" width={200}>
                ...
                <Menu.Dropdown>
                  ...
                  <Menu.Item
                    onClick={() => deleteCommentConfirmation(data?._id)}
