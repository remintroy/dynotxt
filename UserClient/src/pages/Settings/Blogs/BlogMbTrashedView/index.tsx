...
const BlogMbTrashedBlogsSubPage = () => {
  ...
  return (
    <div>
      <Flex direction={"column"} gap={15}>
        {Object.keys(trashedBlogs).filter((key) => !trashedBlogs[key]?.recovered).length == 0 && !isLoading && !isFetching && (
                  ...
                  <Box>
                    <Menu>
                      ...
                      <Menu.Dropdown>
                        ...
                        <Menu.Item color="red" icon={<IconTrash size={14} />} onClick={() => permenentlyDeleteHandler(blog?.blogId)}>
                          Delete permanently
                        </Menu.Item>
                      </Menu.Dropdown>
                    </Menu>
...
export default BlogMbTrashedBlogsSubPage;
